...
Command* shd_vkr_launch_rays(Device* d, Program* p, const char* entry_point, int dimx, int dimy, int dimz, int args_count, void** args, ExtraKernelOptions* extra_options);
