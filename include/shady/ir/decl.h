...
static inline Node* global_var(Module* m, Nodes annotations, const Type* t, String name, AddressSpace as, bool is_ref) { return _shd_global_var(m, annotations, t, name, as, is_ref); }
