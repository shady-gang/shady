...
SpvId spvb_forward_ptr_type(SpvbFileBuilder*, SpvId id, SpvStorageClass storage_class);
...
SpvId spvb_matrix_type(SpvbFileBuilder*, SpvId component_type, uint32_t dim);
...
SpvId spvb_type(SpvbFileBuilder*, SpvOp op, size_t operands_count, SpvId operands[]);
