...
INFIX_OPERATOR(LSL, lshift_logical_tok, lshift_logical_op, 3) \
INFIX_OPERATOR(LSA, lshift_arithm_tok,  lshift_arithm_op,  3) \
INFIX_OPERATOR(RS,  rshift_tok,         rshift_op,         3) \
