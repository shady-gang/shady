...
static bool has_custom_ctor(json_object* node) {
...
static void generate_rewriter_code(Growy* g, Data data) {
    generate_header(g, data);
...
int main(int argc, char** argv) {
    ...
    } else if (strcmp(mode, "rewriter-code") == 0) {
        generate_rewriter_code(g, data);
    } else {
