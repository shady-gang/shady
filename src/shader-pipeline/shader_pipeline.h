...
void shd_pipeline_add_memory_lowering(ShdPipeline pipeline, const ShaderLoweringConfig* tgt, const TargetConfig*);
void shd_pipeline_add_polyfills(ShdPipeline pipeline, const ShaderLoweringConfig* tgt);

void shd_pipeline_add_fncall_emulation(ShdPipeline pipeline, const ShaderLoweringConfig*, const TargetConfig*);
